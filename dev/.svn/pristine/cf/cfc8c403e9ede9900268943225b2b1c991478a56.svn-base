...
class ccopy_files:
    def __init__(self,dst_path,act_path='.'):
        ...
        self.src_expertn_tools=self.src_path+"/expertn_tools"
        self.dst_expertn_tools=dst_path+"/expertn_tools"
    ...
    def create_bin(self):
        file_list = [
                        "expertn_bin"+exe_ext,
                        "expertn_environment.sh",
                        "libexpertn_class"+dll_ext,
                        "libexpertn_modul_base"+dll_ext
                    ]
        if subprocess.mswindows:
			file_list.append("expertn_bin_console"+exe_ext)
    ...
    def expertn_tools(self):
        ...
        self.copy_all(self.src_expertn_tools,self.dst_expertn_tools,"*")
