...
xpn_register_var_init_rec_struct( var_list,STLAYERROOT, pPl->pRoot->pLayerRoot,xpn_register_var_init_pdouble,fActLayWatUptAFbyTree ,"pPl.pRoot.pLayerRoot.fActLayWatUptAFbyTree ",0.0); \
...
xpn_register_var_init_pdouble( var_list, pPl->pDevelop->fCumDTT,"pPl.pDevelop.fCumDTT",0.0);\
...
xpn_register_var_init_pdouble( var_list, pPl->pDevelop->fVernUnit,"pPl.pDevelop.fVernUnit",0.0);\
xpn_register_var_init_pdouble( var_list, pPl->pDevelop->fCumVernUnit,"pPl.pDevelop.fCumVernUnit",0.0);\
...
xpn_register_var_init_pdouble( var_list, pPl->pPltWater->fWaterLossAF,"pPl.pPltWater.fWaterLossAF",0.0);\
xpn_register_var_init_pdouble( var_list, pPl->pPltWater->fWaterGainAF,"pPl.pPltWater.fWaterGainAF",0.0);\
