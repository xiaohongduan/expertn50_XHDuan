...
struct _agroforestry
{
	...
	// FH 20210427 Wind Reduction
	int WindAttenuationTrue, TreeStripPorosityCalculation;
	double TreeStripPorosityFactor, TreeStripPorosityBase, WindSpeedBase, WindDirectionFixed;
	...
	int *iWaterUptakeConsecutive_array, *iWaterUptakeConsecutiveAtGridPoints;
	int iWaterUptakeConsecutive_len;
